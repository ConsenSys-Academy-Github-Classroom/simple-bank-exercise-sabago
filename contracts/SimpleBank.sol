...
contract SimpleBank {
    ...
    // Function modifier to ensure that only enrolled members
    // can make deposits
    ...
    /// @notice The above function can be use on the below function eg
    /// @notice function deposit() public payable onlyEnrolled returns (uint256)

    /// @notice Deposit ether into bank
    /// @return The balance of the user after the deposit is made
    function deposit() public payable onlyEnrolled returns (uint256) {
    ...
    function withdraw(uint256 withdrawAmount) public returns (uint256) {
        ...
        //    sender's balance
        // Want to change the state of the balances before transferring
        balances[msg.sender] -= withdrawAmount;
